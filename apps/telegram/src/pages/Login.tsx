            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-zinc-900/80 backdrop-blur-xl rounded-2xl p-6 border border-white/10">
                    ...
                    <button
                        ...
                        className="w-full py-3.5 px-4 rounded-xl bg-white text-gray-800 font-medium hover:bg-gray-100 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
                    >
                        {googleLoading ? (
